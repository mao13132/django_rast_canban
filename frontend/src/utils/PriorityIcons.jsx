...
/**
 * Возвращает SVG иконку для приоритета задачи
 * @param {string} priority - Приоритет задачи (block/high/medium/low)
 * @param {string} className - CSS класс для иконки
 * @returns {JSX.Element|null} SVG иконка или null
 */
export const getPriorityIcon = (priority, className) => {
  switch (priority) {
    case 'block':
